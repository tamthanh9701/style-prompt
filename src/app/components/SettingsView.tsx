            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '16px' }}>
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                <button className="btn btn-sm" onClick={async () => {
                  ...
                  try {
                    const imgs = await callImageGen({ ...localSettings, image_gen: { ...localSettings.image_gen, enabled: true } }, 'A simple red circle on white background', { sample_count: 1, aspect_ratio: '1:1' });
