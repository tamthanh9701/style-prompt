...
type View = 'library' | 'create' | 'edit' | 'compare' | 'generate' | 'transfer' | 'settings' | 'logs' | 'edit_image';
    ...
    <>
      ...
      <nav className="nav-header">
        ...
        <div className="nav-actions">
          ...
          <button className="btn btn-sm" onClick={() => setView('edit_image')}>{L('nav_edit_image')}</button>
